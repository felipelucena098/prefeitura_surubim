...
$idUsuario = @$res[0]['id'];  
    ...
    $pag = @$_GET["pag"];
    $menu1 = "dados_universitarios";
    $menu2 = "dados_financeiros";
    $menu3 = "";
...
<html lang="pt-br">
    ...
    <head>
        ...
        <meta name="author" content="Felipe Lucena - Diretor de TI">

        <title>Painel do Admiministrador</title>
            ...
            <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                        ...
                        <span>Dados do Universitário</span>
                    </a>
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Dados Universitários</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Dados Financeiros</a>
                             <a class="collapse-item" href="index.php?pag=<?php echo $menu4 ?>">Dados da Faculdade</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fas fa-users"></i>
                        <span>Situação da Bolsa</span>
                    </a>
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu5 ?>">Acompanhar Bolsa</a>
                        </div>
                    </div>
                </li>
        ...
        <div class="modal fade" id="ModalPerfil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="form" method="POST" action="editar-perfil.php">
                        <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label >Informe a Senha Antiga</label>
